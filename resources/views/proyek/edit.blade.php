...
<div class="space-y-8">
    ...
    <div class="bg-white p-8 rounded-xl shadow-md border border-gray-200">
        @if ($errors->any())
            <div class="mb-4 bg-red-50 border-l-4 border-red-400 text-red-700 p-4 rounded-lg" role="alert">
        ...
        <form action="{{ route('proyek.update', $proyek->id_proyek) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="nilai_kontrak" class="block text-sm font-medium text-gray-700 mb-1">Nilai Kontrak</label>
